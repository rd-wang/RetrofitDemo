...
public class TaoBaoDataFeixia {
    ...
    public static void dofeixia() {
        RetrofitUtil.getInstance(TaoBaoApi.class, "https://www.taobao.com")
                .getUrlDetail("https://auldeywj.tmall.com/i/asynSearch.htm?_k" +
                        "sTS=1480128319534_127&callback=jsonp128&mid=w-14621824277-0" +
                        "&wid=14621824277&path=/category.htm&&spm=a1z10.3-b-s.w4011-146" +
                        "21824277.119.fmpJgA&search=y&scene" +
                        "=taobao_shop&pageNo=2").enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                String s = StringEscapeUtils.unescapeHtml4(response.body());
                s = s.replace("jsonp128(\"", "").replace("\")", "").replaceAll("\\\\\"", "\"");
